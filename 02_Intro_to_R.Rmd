...
1. To introduce readers to R and RStudio
2. To introduce readers to RStudio Cloud which is a platform to run RStudio on the cloud
3. To guide you to install R in your local machine 
4. To guide you to install RStudio in your local machine 
5. To show how to install optional; latex editor (Miktex or Texlive and MacTex)
6. To demonstrate how R scripts work
7. To describe about R packages and R Taskview
...
On its webpage, RStudio says that RStudio Cloud is a lightweight, cloud-based solution that allows anyone to do, share, teach and learn data science online. This exciting platform means you can 
...
RStudio Cloud is has the free version and the paid version (which is fortunately very affordable). To start using RStudio Cloud, visit <https://rstudio.cloud/> and register.
...
This is the main webpage for RStudio Cloud. 

![RStudio Cloud main webpage](cloud.PNG)
...
You can run R and RStudio on the server. To do this you have to install  RStudio Server. having RStudio Server enables you to do analysis on the server. Using RStudio server can give you a taste of working on BIG DATA ON THE CLOUD. 
