...
1. be introduced to R programming language
2. be introduced to RStudio\index{RStudio} IDE
3. be introduced to RStudio Cloud\index{RStudio cloud}. RStudio Cloud a platform where users can run RStudio\index{RStudio} on the cloud
4. be able to install R on their local machine 
5. be able to install RStudio IDE on their local machine 
6. understand how to install latex editor (Miktex or Tex Live and MacTex). Latex editor is optional but is required if users want to render PDF outputs. 
7. understand the structure of R scripts\index{R script} work
8. understand R packages\index{Packages} and R Taskview 
...
![RStudio Cloud Registration](cloud2.PNG){width=60%}
...
BlueSky Statistics can help users:
...
![Bluesky Statistics software](bluesky.PNG){width=60%}
...
### Installation of TinyTeX, MiKTeX or MacTeX (for Mac OS) and TeX Live

Based on experience, as you go along, you may find it is very attractive to convert your analysis into PDF document. It is necessary to install Latex editor if you want to convert the outputs you generated in R into PDF format. But if you do not need to produce PDF document, then you do not have to install it.   
...
If you require more functionalities then you may think of getting common latex editors such as :
...
![Console Pane](console.PNG){width=60%}
