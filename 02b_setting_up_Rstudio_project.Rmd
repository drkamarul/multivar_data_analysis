...
At the end of the chapter, we expect readers will be able to   
...
In this chapter, we showed to readers how to set their R environment so they will the same folder and file structures like us. This strategy will minimize the errors they are going to make during analysis. We also show the location of the datasets. They are stored on the GitHub repository for this book. Then, we provided the instructions so readers can create new RStudio projects on RStudio Cloud remotely and on RStudio IDE on their local machines. We achieved this by using HTTP link from our GitHub repository. 
