...
To see further guidance and help, users may register and join RStudio Community at <https://community.rstudio.com/>. Users can also ask questions on Stack Overflow page at <https://stackoverflow.com/>. There are also mailing list groups on specific topics but users have to subscribe to it. 


## Bookdown

RStudio has provided a website to host online books on R at <https://bookdown.org/>. These books are freely accessible and some of the books are available on Amazon or other book depository as physical books. +
