...
![CRAN Task Views](packages.PNG){width="70%"}
...
![Environment pane lists data in the memory. This RStuido IDE uses dark interface](mydata.PNG){width="60%"}
...
![Examples of two books freely accessible on the Bookdown website](bookdown.PNG){width="60%"}
