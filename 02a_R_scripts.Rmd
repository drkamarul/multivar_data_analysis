...
![CRAN Task Views](packages.PNG){width="80%"}
...
![Project Type](new_proj2.PNG){width="70%"}
...
![Environment pane lists data in the memory. This RStudio IDE interface uses the Vibrant Ink theme which users can choose from the Appearence tab in Global Option menu inside the Tools tab](mydata.PNG){width="70%"}
...
![Upload tab on RStudio Cloud](upload_data.PNG){width="80%"}
