...
You may create a different colour plot if you specify the colour outside the `aes` parentheses. For example, let's set the parameter colour to `blue`. Again, in black and white text, readers will not able to see the colour. 
...
Or expand this to make the smooth plot shows different line types for continent:
