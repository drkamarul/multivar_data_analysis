...
- understand the statistical concept of parametric survival analysis
- perform parametric survival analysis specifically the exponential regression model and the Weibull regression model
...
In this chapter we learned briefly the concept of parametric survival analysis. We are also shown how to perform parametric survival analysis using the AFT and PH metrics using the Weibull parametric survival model. 
