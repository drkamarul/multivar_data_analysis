...
Reproducible analysis basically means that for data analyses, and more generally, stories, are published with their data and software code so that others may verify the findings and build upon them.
...
At the end of the chapters, readers will
